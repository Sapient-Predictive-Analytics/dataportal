...
Fungible Tokens at launch: **AGIX**, **BOOK** (now: STUFF), **COPI**, **EMP**, **FLDT**, **GENS**, **HUNT**, **IAG**, **INDY**, **LENFI**, **MELD**, **MILK**, **MIN**, **NEWM**, **NMKR**, **NTX**, **SNEK**, **SUNDAE**, **WMT**, **WRT**. Note that MELD token are no longer updated or included on the website, as the project shut down operations.
